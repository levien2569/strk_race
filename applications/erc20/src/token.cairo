...
mod tests {
    ...
    use starknet::{ContractAddress, syscalls::deploy_syscall, contract_address_const,contract_address_to_felt252};
    ...
    fn deploy() -> (IERC20Dispatcher, ContractAddress) {
        ...
        let (contract_address, _) = deploy_syscall(
            ...
            .unwrap();
        println!("erc20: {}", contract_address_to_felt252(contract_address));
